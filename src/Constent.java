...
public class Constent {
    public static int paintPanelWidth=4000;
    public static int paintPanelHight=4000;
    public static int frameHeight= Toolkit.getDefaultToolkit().getScreenSize().height*2/3;	//根据屏幕大小决定
